...
If the server instead runs as the Ronin background service, update the service on the host and
...
See [Running Ronin in the Background](./background-service.md) for install, status, and removal
commands.
