...
Ronin selects a project icon automatically. It checks `t3.json`, common favicon and app icon
...
Ronin supports SVG, PNG, ICO, JPEG, GIF, AVIF, and WebP files. The selected path applies to
...
Ronin checks in the background and when the server starts. It uses the branch's configured
