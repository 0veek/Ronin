...
On a Linux host, Ronin can run as a background service for your user. It starts when the machine
...
The systemd unit runs a small stable launcher. Exact Ronin versions are installed separately, so
