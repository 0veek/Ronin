 ...
 * `~/.gemini/antigravity-cli/conversations/*.db`) rather than relying on
 * Ronin's own orchestration projections, so usage stays complete even for turns
 * that were never driven through Ronin. This mirrors the approach `ccusage`
 * takes.
 *
