...
export interface DesktopEnvironmentBootstrap {
  ...
  id: string;
  label: string;
  // Optional concrete distro/runtime label for the current backend run.
  // Kept for schema stability; may be null or omitted.
...
export interface PickFolderOptions {
  ...
  // know which local environment they're targeting. Omitting it keeps
  // the historical primary-picker behavior.
