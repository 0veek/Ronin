...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  const commands = {
    ...
    stopAgent: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:stop-agent",
      execute: (input: StopThreadAgentInput) => stopThreadAgent(input),
      scheduler,
      concurrency,
    }),
