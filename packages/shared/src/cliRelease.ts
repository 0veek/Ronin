...
const CLI_RELEASE_REPOSITORY = "0veek/Ronin";
...
/**
 * The archives a release attaches. Kept in step with the `cli_archive` rows
 * in .github/workflows/release.yml: a key here without a build there produces
