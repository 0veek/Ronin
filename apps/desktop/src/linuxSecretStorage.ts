...
function getGnomeKeyringRemediationMessage(): string {
  return "Ronin could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart Ronin.";
}

function getKWalletRemediationMessage(): string {
  return "Ronin could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart Ronin.";
}
