...
it.layer(BaseTestLayer)("OrchestrationProjectionPipeline", (it) => {
  ...
  it.effect("clears pending user input when the provider session is gone", () =>
    Effect.gen(function* () {
      ...
      yield* appendAndProject({
        type: "project.created",
        eventId: EventId.make("evt-gone-session-user-input-1"),
        aggregateKind: "project",
        aggregateId: ProjectId.make("project-gone-session-user-input"),
        occurredAt: "2026-02-26T12:35:00.000Z",
        commandId: CommandId.make("cmd-gone-session-user-input-1"),
        causationEventId: null,
        correlationId: CorrelationId.make("cmd-gone-session-user-input-1"),
        metadata: {},
        payload: {
          projectId: ProjectId.make("project-gone-session-user-input"),
          title: "Project Gone Session User Input",
          workspaceRoot: "/tmp/project-gone-session-user-input",
          defaultModelSelection: null,
          scripts: [],
          createdAt: "2026-02-26T12:35:00.000Z",
          updatedAt: "2026-02-26T12:35:00.000Z",
      ...
      yield* appendAndProject({
        type: "thread.created",
        eventId: EventId.make("evt-gone-session-user-input-2"),
        aggregateKind: "thread",
        aggregateId: ThreadId.make("thread-gone-session-user-input"),
        occurredAt: "2026-02-26T12:35:01.000Z",
        commandId: CommandId.make("cmd-gone-session-user-input-2"),
        causationEventId: null,
        correlationId: CorrelationId.make("cmd-gone-session-user-input-2"),
        metadata: {},
        payload: {
          threadId: ThreadId.make("thread-gone-session-user-input"),
          projectId: ProjectId.make("project-gone-session-user-input"),
          title: "Thread Gone Session User Input",
          modelSelection: {
            instanceId: ProviderInstanceId.make("codex"),
            model: "gpt-5-codex",
          },
      ...
      yield* appendAndProject({
        type: "thread.activity-appended",
        eventId: EventId.make("evt-gone-session-user-input-3"),
        aggregateKind: "thread",
        aggregateId: ThreadId.make("thread-gone-session-user-input"),
        occurredAt: "2026-02-26T12:35:02.000Z",
        commandId: CommandId.make("cmd-gone-session-user-input-3"),
        causationEventId: null,
        correlationId: CorrelationId.make("cmd-gone-session-user-input-3"),
        metadata: {},
        payload: {
          threadId: ThreadId.make("thread-gone-session-user-input"),
          activity: {
            id: EventId.make("activity-gone-session-user-input-requested"),
            tone: "info",
            kind: "user-input.requested",
            summary: "User input requested",
            payload: {
      ...
      yield* appendAndProject({
        type: "thread.activity-appended",
        eventId: EventId.make("evt-gone-session-user-input-4"),
        aggregateKind: "thread",
        aggregateId: ThreadId.make("thread-gone-session-user-input"),
        occurredAt: "2026-02-26T12:35:03.000Z",
        commandId: CommandId.make("cmd-gone-session-user-input-4"),
        causationEventId: null,
        correlationId: CorrelationId.make("cmd-gone-session-user-input-4"),
        metadata: {},
        payload: {
          threadId: ThreadId.make("thread-gone-session-user-input"),
          activity: {
            id: EventId.make("activity-gone-session-user-input-failed"),
            tone: "error",
            kind: "provider.user-input.respond.failed",
            summary: "Provider user input response failed",
            payload: {
      ...
      const threadRows = yield* sql<{
        ...
        SELECT pending_user_input_count AS "pendingUserInputCount"
        FROM projection_threads
        WHERE thread_id = 'thread-gone-session-user-input'
      `;
      assert.deepEqual(threadRows, [{ pendingUserInputCount: 0 }]);
    }),
  );
