...
const RONIN_DEVICE_TOOL_INSTRUCTIONS = `
...
const normalizeAvailability = (
  availability: boolean | RoninToolAvailability,
): RoninToolAvailability =>
...
export const codexPlanModeDeveloperInstructions = (
  browserToolsAvailable: boolean | RoninToolAvailability,
