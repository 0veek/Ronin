...
/**
 * Client captured the plan for Ronin's proposed-plan card. Abandon the native
 * Grok plan-approval gate so the turn unblocks; the user implements via Ronin's UI.
 */
