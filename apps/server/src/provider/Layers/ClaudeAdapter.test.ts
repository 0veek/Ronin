  ...
  it.effect("derives bypass permission mode from full-access runtime policy", () => {
    ...
    return Effect.gen(function* () {
      ...
      assert.deepEqual(createInput?.options.systemPrompt, {
        ...
        preset: "claude_code",
        append:
          "<runtime_info>In case you're asked: you are running in Ronin through the Claude Code harness. No need to mention this otherwise. You can embed images and videos in your response using Markdown with absolute file paths.</runtime_info>",
      });
    ...
    return Effect.gen(function* () {
      ...
      const bashPermissionPromise = canUseTool(
        ...
        { command: "git status" },
        {
          ...
          requestId: "request-bash-session-1",
        },
      );
      yield* respondToNextRequest;
  ...
  it.effect("routes Claude resume compaction through the shared user-input UI", () => {
    ...
    return Effect.gen(function* () {
      ...
      const dialogPromise = onUserDialog(
        ...
        { signal: new AbortController().signal, requestId: "request-resume-dialog-1" },
      );
    ...
    return Effect.gen(function* () {
      ...
      const permissionPromise = canUseTool(
        ...
        },
        {
          ...
          requestId: "request-ask-pre-aborted",
        },
      );
