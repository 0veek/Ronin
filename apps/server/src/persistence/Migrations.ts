...
import Migration0041 from "./Migrations/041_ProviderSessionLedger.ts";
import Migration0042 from "./Migrations/042_ProjectionThreadMessageProvider.ts";
import Migration0043 from "./Migrations/043_ProjectionThreadsSideChat.ts";
import Migration0044 from "./Migrations/044_Automations.ts";
import Migration0045 from "./Migrations/045_AutomationFailurePolicy.ts";
import Migration0046 from "./Migrations/046_ProjectionThreadsQueuedPrompt.ts";
import Migration0047 from "./Migrations/047_ProjectionThreadsComparisonGroup.ts";
import Migration0048 from "./Migrations/048_BuildSystems.ts";
import Migration0049 from "./Migrations/049_ProviderSessionLedgerDelivery.ts";
import Migration0050 from "./Migrations/050_ProjectionThreadLinkedPullRequest.ts";
import Migration0051 from "./Migrations/051_ProjectionThreadsUnsettledAt.ts";
import Migration0052 from "./Migrations/052_ClearAutomaticProjectModelDefaults.ts";
...
import Migration0055 from "./Migrations/055_ProjectionProjectIcon.ts";
import Migration0056 from "./Migrations/056_ProjectionThreadBranchPullRequest.ts";
import Migration0057 from "./Migrations/057_ProjectionThreadsActiveOrderKey.ts";
import Migration0058 from "./Migrations/058_ProjectionThreadPullRequests.ts";
import Migration0059 from "./Migrations/059_ProjectionThreadMessageContext.ts";
...
export const migrationEntries = [
  ...
  [41, "ProviderSessionLedger", Migration0041],
  [42, "ProjectionThreadMessageProvider", Migration0042],
  [43, "ProjectionThreadsSideChat", Migration0043],
  [44, "Automations", Migration0044],
  [45, "AutomationFailurePolicy", Migration0045],
  [46, "ProjectionThreadsQueuedPrompt", Migration0046],
  [47, "ProjectionThreadsComparisonGroup", Migration0047],
  [48, "BuildSystems", Migration0048],
  [49, "ProviderSessionLedgerDelivery", Migration0049],
  [50, "ProjectionThreadLinkedPullRequest", Migration0050],
  [51, "ProjectionThreadsUnsettledAt", Migration0051],
