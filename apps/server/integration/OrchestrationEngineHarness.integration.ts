...
import { layer as ProviderSessionLedgerRepositoryLive } from "../src/persistence/ProviderSessionLedger.ts";
...
import { QuotaResumeReactor } from "../src/orchestration/Services/QuotaResumeReactor.ts";
import { BuildSystemRunReactor } from "../src/orchestration/Services/BuildSystemRunReactor.ts";
...
export const makeOrchestrationIntegrationHarness = (
  ...
  Effect.gen(function* () {
    ...
    const providerSessionDirectoryLayer = ProviderSessionDirectoryLive.pipe(
      ...
      Layer.provide(ProviderSessionLedgerRepositoryLive),
    );
    ...
    const orchestrationReactorLayer = OrchestrationReactorLive.pipe(
      ...
      Layer.provideMerge(
        Layer.succeed(QuotaResumeReactor, {
          start: () => Effect.void,
          drain: Effect.void,
        }),
      ),
