...
function toHydratedDraftThreadState(
  ...
  return {
    ...
    ...(persistedDraftThread.sideChat !== undefined
      ? { sideChat: persistedDraftThread.sideChat as ThreadSideChatOrigin | null }
      : {}),
        ...
        setDraftThreadContext: (threadRef, options) => {
          ...
          set((state) => {
            ...
            const nextDraftThread: DraftThreadState = {
              ...
              startFromOrigin: nextStartFromOrigin,
              sideChat: options.sideChat ?? existing.sideChat ?? null,
            ...
            const isUnchanged =
              ...
              nextDraftThread.sideChat === existing.sideChat &&
...
export function markPromotedDraftThread(threadId: ThreadId): void {
  ...
  for (const [draftId, draftThread] of Object.entries(store.draftThreadsByThreadKey)) {
    if (draftThread.threadId === threadId) {
      store.markDraftThreadPromoting(DraftId.make(draftId));
    }
  }
}
