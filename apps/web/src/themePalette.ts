...
export const OLED_VOID_THEME: ThemeDefinition = {
  ...
  // Every curated theme opts in. The flag is new from upstream, and before it
  // existed the stage artwork was gated only by the user's identification
  // setting -- leaving one of the five out would silently turn the artwork off
  // for it, which is a behaviour change nobody asked for.
  sidebarArtwork: true,
};
