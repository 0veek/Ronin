  ...
  "flex shrink-0 items-center justify-center [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    ...
    variants: {
      variant: {
        ...
        icon: "relative flex size-9 shrink-0 items-center justify-center rounded-[var(--control-radius)] border bg-card not-dark:bg-clip-padding text-foreground [&_svg:not([class*='size-'])]:size-4.5",
      },
    },
  },
);
