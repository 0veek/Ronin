      ...
      {variant === "switch" ? (
        <>
          ...
          <MenuPrimitive.CheckboxItemIndicator
            className="inline-flex h-[calc(var(--thumb-size)+2px)] w-[calc(var(--thumb-size)*2-2px)] shrink-0 items-center focus-ring rounded-full p-px transition-colors duration-(--duration-base) [--thumb-size:--spacing(4)] data-checked:bg-primary data-unchecked:bg-input data-disabled:opacity-64 sm:[--thumb-size:--spacing(3)]"
            keepMounted
          >
