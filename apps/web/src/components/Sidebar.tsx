                          ...
                          >
                            ...
                            >
                              {/* Pinned rows keep their flat, user-arranged order:
                                  side-chat grouping would reshuffle a list the
                                  user dragged into place, and the drag machinery
                                  keys off this exact sequence. */}
                    ...
                    items.push(
                      ...
                      >
                        ...
                        >
                          ...
                          <span className="h-0 flex-1 border-t border-dotted border-sidebar-border" />
                          <ChevronDownIcon
                            aria-hidden
                            className={cn(
