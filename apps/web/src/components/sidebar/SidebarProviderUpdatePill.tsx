...
export function SidebarProviderUpdatePill() {
  ...
  return (
    <div
      className={`group/provider-update relative flex min-h-7 w-full shrink-0 items-center overflow-hidden rounded-lg text-2xs leading-4 font-medium transform-gpu transition-all duration-(--duration-base) ease-[cubic-bezier(0.22,1,0.36,1)] will-change-transform ${
