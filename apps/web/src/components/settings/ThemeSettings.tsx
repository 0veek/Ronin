...
export function ThemeLibrary({
  ...
  // shows Ronin selected instead of nothing.
  ...
  return (
    <div className="space-y-3">
      <p className="px-3 text-sm leading-[1.45] text-muted-foreground/80 sm:px-4">
        Choose how Ronin looks. Use a built-in theme or make your own.
      </p>
                      ...
                      {card.previews.map((preview) => (
                        ...
                        >
                          <span className="flex scale-75">
                            <ThemePreviewSwatch colors={preview.colors} mode={preview.mode} />
                          </span>
                        </span>
                      ))}
                    </span>
