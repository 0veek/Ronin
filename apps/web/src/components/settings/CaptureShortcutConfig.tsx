  ...
  return (
    <div className="space-y-4 text-sm">
      ...
      {result ? (
        ...
        <>
          <p className="text-muted-foreground">
            Allow Ronin to read your desktop settings. You'll review any changes here before saving.
          </p>
          <Button
          ...
          {!supported ? (
            <p className="text-xs text-muted-foreground">
              Update Ronin to finish setting up your shortcut.
            </p>
          ) : null}
        </>
      )}
      ...
      {state.shortcutActionRegistered === false && state.shortcutMessage ? (
        <p role="status" className="text-muted-foreground">
          {state.shortcutPending
            ...
            : "Restart Ronin to finish connecting your shortcut."}
        </p>
      ) : null}
      <details className="text-xs text-muted-foreground">
        ...
        <div className="mt-3 space-y-3">
          ...
          <div className="space-y-1">
            ...
            {niri ? <p>Ronin also reads any files included by this file.</p> : null}
          ...
          <p>
            Turn capture off in Ronin to stop it. Remove the shortcut from {desktop} to free up the
            keys.
          </p>
