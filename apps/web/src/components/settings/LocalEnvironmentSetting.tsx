  ...
  return (
    <>
      <SettingsRow
        ...
        description={
          enabled
            ? "Run agents on this computer. Turn off to use Ronin only with remote environments."
      ...
      >
        <AlertDialogPopup>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {enabled
                ? "Ronin will restart without running a server on this computer. Any agents and terminals running here will stop, and other devices will no longer be able to connect to this computer. Your projects, history, and remote environments are unaffected."
                : "Ronin will restart and start running a server on this computer again."}
            </AlertDialogDescription>
          </AlertDialogHeader>
