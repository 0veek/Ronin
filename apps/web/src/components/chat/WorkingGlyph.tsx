...
/** A tiny two-beat ronin duel shown while the active turn is running. */
export function WorkingGlyph({ className }: { className?: string }) {
  return (
    <svg
      aria-hidden
      className={cn("working-glyph h-5 w-11 shrink-0 text-primary", className)}
      fill="none"
      focusable="false"
      viewBox="0 0 44 20"
    >
      <path className="working-glyph-ground" d="M3 18H41" pathLength="1" />
