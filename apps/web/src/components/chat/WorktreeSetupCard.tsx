...
function SetupHeaderRow({
  ...
  return (
    <div className="border-b border-border/60 pb-2 pt-1">
      ...
      >
        <span className="relative min-w-0 shrink overflow-hidden whitespace-nowrap">
  ...
  return (
    <section aria-label="Worktree setup" data-worktree-setup-phase={snapshot.phase}>
      ...
      <div className="mt-0.5 ml-[calc(--spacing(6)+2px-(--spacing(2)-1px))] flex flex-wrap items-center gap-0.5">
        ...
        {showTerminal ? (
          <Button type="button" size="xs" variant="ghost" onClick={onOpenTerminal}>
            <TerminalIcon aria-hidden />
            Open terminal
          </Button>
        ) : null}
        {onWorkLocally ? (
          <Button type="button" size="xs" variant="ghost" onClick={onWorkLocally}>
