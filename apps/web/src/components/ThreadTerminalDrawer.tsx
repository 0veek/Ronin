            ...
            <aside className="flex w-36 min-w-36 flex-col border border-border/70 bg-muted/10">
              ...
              <div className="min-h-0 flex-1 overflow-y-auto px-1 py-1">
                {resolvedTerminalGroups.map((terminalGroup) => {
                  ...
                  // "Group 3" said nothing a reader could act on. The split
                  // shape is what distinguishes one group from the next, so
                  // the header names that instead and counts its panes.
                        ...
                        {terminalGroup.terminalIds.map((terminalId) => {
                          ...
                          return (
                            <div
                              key={terminalId}
                              className={cn(
                                "group/tab flex h-6 w-full items-center gap-0.5 rounded-md pr-2 pl-1.5 text-2xs",
                                isActive
