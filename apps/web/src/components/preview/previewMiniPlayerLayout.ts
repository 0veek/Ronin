...
// Keep the DOM frame and Electron's native webview clip in lockstep with
// Ronin's compact 8px floating-preview corners.
export const PREVIEW_MINI_PLAYER_CORNER_RADIUS = 8;
