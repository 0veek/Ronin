  ...
  return (
    ...
    >
      ...
      <div className="relative min-h-0 flex-1 overflow-hidden">
        ...
        {controller !== "none" ? (
          <div className="pointer-events-none absolute left-3 top-3 z-40 rounded-(--control-radius) border border-border bg-background px-2.5 py-1 text-2xs font-medium shadow-(--shadow-popover)">
