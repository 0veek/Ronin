...
/*
 * Duration for the strip's reflow.
 *
 * A literal rather than a motion token, and deliberately: the label crossfade
 * beside it is a Tailwind class (`duration-180`) that cannot interpolate a
 * value, and the two halves have to agree or the labels finish moving before
 * the controls they sit in do. Changing one means changing the other -- grep
 * duration-180 in BranchToolbar*.tsx.
 *
 * Reduced motion is honoured explicitly below rather than through the token,
 * for the same reason.
 */
...
export const BranchToolbar = memo(function BranchToolbar({
  ...
  return (
    <div
      ...
      className="composer-context-strip group/composer-context flex w-full items-center gap-2 ps-2 pe-2 py-1.5"
    >
