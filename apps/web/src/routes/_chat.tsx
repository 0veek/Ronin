  ...
  useEffect(() => {
    const onWindowKeyDown = (event: KeyboardEvent) => {
      ...
      if (command === "chat.new") {
        event.preventDefault();
        event.stopPropagation();
        // Creation routes through the command palette whenever there is a
        // real choice to make; single-project setups keep the immediate
        // contextual create.
        ...
        if (!isPreviewSupportedInRuntime()) {
          toastManager.add(
            stackedThreadToast({
              ...
              description: "Open Ronin in the desktop app to use the in-app preview.",
            }),
          );
          return;
        }
...
function ChatRouteLayout() {
  // Both thread routes render here so draft promotion keeps one ChatView mounted.
