/**
 * Vocabulary for the "stop after N consecutive start-failures" picker.
 *
 * The contract stores `null` as never-stop and a positive integer as the
 * threshold. The form talks in the words the user would pick.
 */
import { DEFAULT_AUTOMATION_STOP_AFTER_CONSECUTIVE_FAILURES } from "@t3tools/contracts";
