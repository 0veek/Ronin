...
export function BrowserDeviceToolbar({
  ...
  return (
    <div
      className="sticky left-0 top-0 z-50 flex items-center gap-0.5 overflow-x-auto border-b border-border bg-background px-1.5 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
