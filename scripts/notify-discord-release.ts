  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Ronin prerelease is available for nightly testers."
          : "A new Ronin latest release is available.",
...
).pipe(Command.withDescription("Post a Ronin release announcement to Discord."));
