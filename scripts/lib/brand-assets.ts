export const BRAND_ASSET_PATHS = {
  ...
  productionIosIconPng: "assets/prod/ronin-ios-1024.png",
  productionMacIconPng: "assets/prod/ronin-macos-1024.png",
  productionLinuxIconPng: "assets/prod/ronin-universal-1024.png",
  productionWindowsIconIco: "assets/prod/ronin-windows.ico",
  productionWebFaviconIco: "assets/prod/ronin-web-favicon.ico",
  productionWebFavicon16Png: "assets/prod/ronin-web-favicon-16x16.png",
  productionWebFavicon32Png: "assets/prod/ronin-web-favicon-32x32.png",
  productionWebAppleTouchIconPng: "assets/prod/ronin-web-apple-touch-180.png",
